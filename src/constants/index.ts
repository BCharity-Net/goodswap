...
export const ROUTER_ADDRESS: { [chainId in ChainId]?: string } =  {
  ...
  [ChainId.AMOY]: '0x656D9BED06a72E8A72307bdeB1a743E9d6d30a58',
...
export const TESTGOOD = new Token(
  ChainId.AMOY,
  '0x2d4139144F9Dc09C4A97Dd1fFA83acAf60ff275E',
  18,
  'GOOD',
  'GiveSwap Token'
)
export const TESTUSDC = new Token(
  ChainId.AMOY,
...
export const SUGGESTED_BASES: ChainTokenList = {
  ...
  [ChainId.AMOY]: [TESTGOOD ,TESTUSDC]
}
...
export const PINNED_PAIRS: { readonly [chainId in ChainId]?: [Token, Token][] } = {
  [ChainId.METISTEST]: [
    [
      ...
      // new Token(ChainId.AMOY, '0x0f548051B135fa8f7F6190cb78Fd13eCB544fEE6', 8, 'HUSD', 'Polygon USD')
    ]
  ],
  [ChainId.METIS]: [
    [
  ...
  [ChainId.OKTEST]: [
    [
      ...
      new Token(ChainId.OKTEST, '0xC80f4a6DB039e63dbCC4D7286B77AF14D7DB16Df', 18, 'USDK', 'Polygon USD')
    ]
  ]
}
