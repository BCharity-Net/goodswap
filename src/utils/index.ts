...
import IGiveSwapRouter from 'giveswap-core/build/contracts/IGiveSwapRouter.json'
...
export function getRouterContract(chainId: ChainId, library: Web3Provider, account?: string): Contract {
  return getContract(ROUTER_ADDRESS[chainId], IGiveSwapRouter.abi, library, account)
}
